  ...
  >
    <div class="top-bar-content">
      ...
      <div class="right-buttons">
        <button class="topbar-white-btn back-button" @click="goBack">
          Back to Start Page
        </button>
        <button
          class="pin-button"
        ...
        >
          ...
          >
            ...
            <path
              v-else
              d="M14,4V8.5L12,6.5L10,8.5V4H14M16,2H8V10L12,6L16,10V2M18,12.5V11H16.5V12.5H18M18,16V14.5H16.5V16H18M12,20V18.5H10.5V20H12M8,20V18.5H6.5V20H8M8,16V14.5H6.5V16H8M12,16V14.5H10.5V16H12M8,12.5V11H6.5V12.5H8M12,12.5V11H10.5V12.5H12"
            />
          </svg>
        </button>
      </div>
