...
export default {
  ...
  methods: {
    initializeGame() {
      ...
      console.log('Initializing game with mode:', this.mode, 'and gameId:', this.gameId);
      ...
      this.view = new ChessEngine.View(this.$refs.boardElement, this.game, this.perspective, this.onMoveCallback);
